...
import { LoadingSplash, LOADING_SPLASH_BUILD } from './LoadingSplash';
  ...
  return (
    <div className="relative h-full min-h-0 overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-x-0 top-0 z-[210] bg-gradient-to-b from-black/55 to-transparent px-4 pb-8 pt-[max(0.75rem,env(safe-area-inset-top))]">
        <h1 className="pointer-events-auto text-sm font-bold text-white">Loading 预览 · {LOADING_SPLASH_BUILD}</h1>
        <p className="pointer-events-auto mt-0.5 text-xs text-white/75">大小错落 · 11 个 emoji · 已优化性能</p>
      </div>
